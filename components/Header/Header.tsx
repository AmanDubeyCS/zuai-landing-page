    ...
    <div className="sticky top-0 z-[51] w-full bg-white">
      <header className="mx-auto flex max-w-[992px] items-center justify-center bg-white px-2 py-4">
        <div className="flex w-full items-center justify-between self-stretch">
          ...
          <div className="flex h-[40px] items-center rounded-[24px] bg-[#6947BF] px-[24px] text-lg font-bold leading-[140%] tracking-[0.18px] text-white shadow-[0_2px_8px_0px_rgba(0,0,0,0.04)]">
            Count me in!
          </div>
        </div>
      </header>
