...
export function Hero() {
  return (
    <section
      id="hero-container"
      className="relative flex h-dvh max-h-[820px] min-h-[560px] w-full items-center overflow-hidden bg-white font-gilroy"
    >
      ...
      <div className="mx-auto flex h-full max-w-7xl flex-col justify-center px-6 pb-16 pt-0 sm:pb-24 lg:px-8 lg:pt-28">
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="flex flex-col items-center">
            <h1 className=" mx-auto max-w-xl text-center text-4xl font-semibold tracking-tighter text-black transition-all sm:text-7xl lg:max-w-3xl lg:text-[88px]">
            ...
            <p className="mx-auto mt-4 max-w-xl text-center text-lg font-medium leading-6 tracking-tight text-black/60 sm:mt-8 sm:text-2xl sm:leading-normal lg:max-w-3xl">
              ZuAI personalizes exam prep for 90% of IBDP students
            </p>
            <CTAButton />
          </div>
        </div>
