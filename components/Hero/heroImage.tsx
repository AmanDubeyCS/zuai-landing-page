    ...
    >
      <div className="mx-auto max-w-[664px] px-4 lg:hidden">
        <iframe
          ...
          allowFullScreen
          className="mx-auto h-[400px] w-full rounded-[16px] border-[12px] border-blue-950"
        />
          ...
          <div className="sticky top-0 z-50 mx-auto flex h-fit w-full items-start justify-center">
            <div className="relative z-10 grid w-full place-items-center px-4">
              <iframe
                ...
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
                className="3xl:h-[850px] 3xl:w-[1200px] h-[500px] w-[700px] rounded-[16px] border-[12px] border-blue-950 2xl:h-[600px] 2xl:w-[800px]"
              />
            </div>
          </div>
        </div>
